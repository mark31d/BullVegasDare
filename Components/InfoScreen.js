...
const styles = StyleSheet.create({
  ...
  card: {
    backgroundColor: NAVY, borderRadius: 26, padding: 18,
    alignItems: 'center',top:120,
  },
  text: { color: TEXT, fontSize: 16, lineHeight: 24, alignSelf: 'stretch', marginBottom: 16 },
  appImg: { width: 260, height: 240, marginVertical: 12  , borderRadius:60,},

  primaryBtn: { backgroundColor: ORANGE, borderRadius: 16, paddingVertical: 14, paddingHorizontal: 28, marginTop: 4 },
  primaryTxt: { color: TEXT, fontSize: 16, fontWeight: '800' },
});
