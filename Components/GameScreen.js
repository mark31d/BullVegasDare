...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: NAVY, borderRadius: 22, padding: 16 },
  bold: { color: '#fff', fontSize: 16, fontWeight: '800', marginBottom: 10 },
  ...
  taskIconBox: {
    width: 84, height: 84, borderRadius: 14, backgroundColor: '#0f2a43',
  ...
  secondaryBtn: {
    borderColor: 'rgba(215,122,43,0.7)',
    borderWidth: 1.2,
    borderRadius: 16,
    paddingVertical: 18,
    alignItems: 'center',
  ...
  secondaryTxt: { color: '#fff', fontSize: 16, fontWeight: '700' },
