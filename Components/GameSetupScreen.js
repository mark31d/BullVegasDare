...
const styles = StyleSheet.create({
  ...
  // Карточки
  card: { backgroundColor: NAVY, borderRadius: 22, padding: 18, marginBottom: 18 },
  ...
  input: {
    flex: 1, backgroundColor: '#121826', color: '#fff', borderRadius: 14,
    paddingHorizontal: 16, paddingVertical: 12, fontSize: 16,
  },
  plus: {
    width: 44, height: 44, borderRadius: 12, backgroundColor: ORANGE,
  ...
  plusTxtLarge: { color: '#fff', fontSize: 28, fontWeight: '900', marginTop: -2 },
  ...
  primaryTxt: { color: '#fff', fontSize: 18, fontWeight: '900' },
});
